        ...
        describe("batch_size=1", () => {
            it(
                ...
                async () => {
                    ...
                    const target = [
                        {
                            score: 0.0013377574505284429,
                            token: 854,
                            token_str: "##ο",
                            sequence: "aο c",
                        },
                        {
                            score: 0.001248967950232327,
                            token: 962,
                            token_str: "##ち",
                            sequence: "aち c",
                        },
                        {
                            score: 0.0012304208939895034,
                            token: 933,
                            token_str: "##ع",
                            sequence: "aع c",
                        },
            ...
            it(
                ...
                async () => {
                    ...
                    const target = [
                        ...
                        [
                            {
                                score: 0.0013287801994010806,
                                token: 962,
                                token_str: "##ち",
                                sequence: "a bち c",
                            },
                            {
                                score: 0.0012486606137827039,
                                token: 823,
                                token_str: "##ن",
                                sequence: "a bن c",
                            },
                            {
                                score: 0.0012320734094828367,
                                token: 1032,
                                token_str: "##ც",
                                sequence: "a bც c",
                            },
                            {
                                score: 0.0012295148335397243,
                                token: 854,
                                token_str: "##ο",
                                sequence: "a bο c",
                            },
                            {
                                score: 0.0012277684872969985,
                                token: 624,
                                token_str: "未",
                                sequence: "a b 未 c",
                            },
        ...
        describe("batch_size=1", () => {
            it(
                ...
                async () => {
                    const output = await pipe("a", "b c");
                    const target = {
                        score: 0.11395696550607681,
                        /* start: 0, end: 1, */ answer: "b",
                    };
                    compare(output, target, 1e-5);
                },
                MAX_TEST_EXECUTION_TIME,
        ...
        describe("batch_size=1", () => {
            ...
            it(
                ...
                async () => {
                    ...
                    const target = [
                        {
                            score: 0.020360443741083145,
                            label: "LABEL_31",
                            box: { xmin: 56, ymin: 55, xmax: 169, ymax: 167 },
                        },
                        {
                            score: 0.020360419526696205,
                            label: "LABEL_31",
                            box: { xmin: 56, ymin: 55, xmax: 169, ymax: 167 },
                        },
                        {
                            score: 0.02036038413643837,
                            label: "LABEL_31",
                            box: { xmin: 56, ymin: 55, xmax: 169, ymax: 167 },
                        },
                        {
                            score: 0.020360447466373444,
                            label: "LABEL_31",
                            box: { xmin: 56, ymin: 55, xmax: 169, ymax: 167 },
                        },
                        {
                            score: 0.020360389724373817,
                            label: "LABEL_31",
                            box: { xmin: 56, ymin: 55, xmax: 169, ymax: 167 },
                        },
                        {
                            score: 0.020360423251986504,
                            label: "LABEL_31",
                            box: { xmin: 56, ymin: 55, xmax: 169, ymax: 167 },
                        },
                        {
                            score: 0.02036040835082531,
                            label: "LABEL_31",
                            box: { xmin: 56, ymin: 55, xmax: 169, ymax: 167 },
                        },
                        {
                            score: 0.020360363647341728,
                            label: "LABEL_31",
                            box: { xmin: 56, ymin: 55, xmax: 169, ymax: 167 },
                        },
                        {
